---
title: "PitchPro Auth Endpoints — Register, Login, Refresh, Logout"
sidebarTitle: "Auth Endpoints"
description: "Reference for all five /api/auth endpoints: register, login, token refresh, logout, and current-user profile. Includes validation rules and error codes."
---

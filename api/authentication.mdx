---
title: "Authenticating Requests to the PitchPro API"
sidebarTitle: "Authentication"
description: "How to obtain a JWT access token via login and pass it in requests to protected PitchPro API endpoints. Covers token refresh and logout."
---

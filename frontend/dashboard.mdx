...
description: "Tour the PitchPro React dashboard: system health stats, courts table, reservations list, and dialog-based CRUD for managing courts and bookings."
---
